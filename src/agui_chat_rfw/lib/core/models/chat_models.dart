...
class ChatUser extends Equatable {
  ...
  static const ChatUser agent = ChatUser(
    id: 'agent',
    firstName: 'Agent',
  );

  /// Predefined user for system messages.
  static const ChatUser system = ChatUser(
    id: 'system',
    firstName: 'System',
  );
}
...
class GenUiContent extends Equatable {
  ...
  GenUiContent copyWith({
    ...
    return GenUiContent(
      ...
      libraryBlob: libraryBlob ?? this.libraryBlob,
      libraryText: libraryText ?? this.libraryText,
      data: data ?? this.data,
    );
  }
